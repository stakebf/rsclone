...
import classes from './panelWindowInviteLink.module.scss';

type PanelWindowInviteLinkProps = {
  boardId: string;
};

const PanelWindowInviteLink: React.FC<PanelWindowInviteLinkProps> = ({boardId}) => {
